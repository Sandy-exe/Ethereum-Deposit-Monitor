...
export class DepositsTrackerService implements IDepositsTrackerService {
  ...
  public async processBlockTransactionsFrom(blockNumber: number) {
    ...
    console.info(lastStoredBlockNumber);

    // const lastStoredBlockNumber = (await this.depositsRepository.getLatestStoredBlock()) || blockNumber;
    //   console.info("lastStoredBlockNumber:", lastStoredBlockNumber);
